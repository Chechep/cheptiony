    ...
    >
      <div className="relative flex items-center justify-center w-full">
        ...
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-lg md:hidden hover:bg-gray-200 dark:hover:bg-gray-700"
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 z-[1001] rounded-full bg-[#333] text-white p-2 md:p-3 
                     cursor-pointer transition-all duration-300 hover:bg-[#555] hover:scale-110 
                     dark:bg-[#555] dark:text-white"
          aria-label="Toggle dark mode"
        >
          <span className="relative flex items-center justify-center w-5 h-5">
            <Sun
              size={18}
              className={`absolute transition-all duration-500 ${darkMode ? "opacity-100 rotate-0 text-yellow-400" : "opacity-0 -rotate-90"}`}
            />
            <Moon
              size={18}
              className={`absolute transition-all duration-500 ${darkMode ? "opacity-0 rotate-90" : "opacity-100 rotate-0 text-blue-300"}`}
            />
          </span>
        </button>
      </div>
      ...
      >
        ...
        <div className="absolute bottom-6 left-0 w-full px-6 text-sm text-gray-700 dark:text-gray-300 space-y-3">
          <a href="mailto:cheptiony6@gmail.com" className="flex items-center gap-2 hover:text-blue-500">
            <Mail size={16} /> cheptiony6@gmail.com
          </a>
          <a href="tel:+254790086093" className="flex items-center gap-2 hover:text-green-500">
            <Phone size={16} /> +254 790 086 093
          </a>
          <a href="https://wa.me/254790086093" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-600">
            <Phone size={16} /> WhatsApp
          </a>
          <a href="https://github.com/Chechep" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-gray-900 dark:hover:text-white">
